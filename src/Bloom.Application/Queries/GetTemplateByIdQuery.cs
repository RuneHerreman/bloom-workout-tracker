...
//     Guid TemplateId
// ): IRequest<Result<WorkoutTemplateData>>;
//
// public class GetTemplateByIdQueryHandler
//     : IRequestHandler<GetTemplateByIdQuery, Result<WorkoutTemplateData>>
// {
...
//
//
//     public async Task<Result<WorkoutTemplateData>> Handle(
...
//             return Result<WorkoutTemplateData>.Failure("User not authenticated or not found");
//         
...
//
//         if (template == null)
//             return Result<WorkoutTemplateData>.Failure("Template not found");
//         
...
//         
//         return Result<WorkoutTemplateData>.Success(template.ToDto(exerciseNames));
//     }
// }